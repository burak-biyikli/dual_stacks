...
void analyzer_get_pc_stats(uint64_t* sum_possible_push, uint64_t* sum_possible_pop, uint64_t* hist_sum_push, uint64_t* hist_sum_pop, uint32_t* unique_pcs, uint32_t* unique_ipc_pcs) {
    *sum_possible_push = 0;
    *sum_possible_pop = 0;
    *hist_sum_push = 0;
    *hist_sum_pop = 0;
