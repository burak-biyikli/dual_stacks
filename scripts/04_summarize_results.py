...
def summarize_run(run_dir):
    ...
    for bench_dir in bench_dirs:
        ...
        try:
            ...
            # Note: histo_sum == push is NOT always true natively because some threads die without being cleaned up, but it MUST be <=.
            # Actually, analyzer_cleanup is called at exit, so all pushes SHOULD be popped or forcefully evicted by the max-clock approximation.
            # We will use <= for safety because of extreme edge cases (like crash).
